...
class WorldMap:
    ...
    def draw_stone_line(self, x_start, y_start, x_end, y_end):
        ...
        if y_start > self.lowest_y:
            self.lowest_y = y_start
        elif y_end > self.lowest_y:
            self.lowest_y = y_start
...
if __name__ == "__main__":
    ...
    with open("input") as f:
        ...
        world_map.draw_stone_line(0, 163, world_map.size - 1, 163)
    is_hole_closed = False
    while not is_hole_closed:
        ...
        while world_map.get_cell(world_map.sand_y, world_map.sand_x).is_falling:
            ...
            if world_map.sand_y == 0 and world_map.sand_x == 500:
                is_hole_closed = True
                break
